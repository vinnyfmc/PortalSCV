<%@ Page Language="C#" MasterPageFile="~/Shared/Principal.Master" AutoEventWireup="true" CodeBehind="ClienteCad.aspx.cs" Inherits="PortalSCV.Layout.Cliente.ClienteCad" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <h1 class="page-header">Cadastro de Cliente
                </h1>
            ...
            <div class="col-lg-12">
                <asp:UpdatePanel runat="server" ID="PanelAviso">
                    <ContentTemplate>
                        ...
                        <asp:HiddenField runat="server" ID="Cliente_Id" />
                    </ContentTemplate>
                    <Triggers>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    <label>Nome</label>
                    <asp:TextBox runat="server" ID="txtNome" CssClass="form-control" placeholder="Digite o nome completo do cliente"></asp:TextBox>
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group">
